...
def main():
    ...
    for category in ['a', 'b', 'c', 'd']:
        ...
        for block_file in category_dir.glob("*.block.json"):
            # Wyciągnij nazwę znaku (bez .block.json)
            sign_id = block_file.stem.replace('.block', '')
    ...
    print(f"Znaki ze specjalnymi wymiarami: {special_sizes_count}")
