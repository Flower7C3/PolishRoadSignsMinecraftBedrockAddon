...
echo "  python build_mcaddon.py&& python unpack_and_install_mcaddon.py dist/PolishRoadSigns_*.mcaddon"
echo ""
echo "To run build scripts:"
echo "  python build_mcaddon.py"
echo "  python build_mcpack.py"
echo ""