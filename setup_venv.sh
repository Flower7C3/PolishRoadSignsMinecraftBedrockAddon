...
echo "  python3 build_mcaddon.py && python3 unpack_and_install_mcaddon.py dist/PolishRoadSigns_*.mcaddon"
echo ""
echo "To run build scripts:"
echo "  python3 build_mcaddon.py"
echo "  python3 build_mcpack.py"
echo ""